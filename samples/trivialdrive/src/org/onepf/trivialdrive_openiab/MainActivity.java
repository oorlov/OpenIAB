...
public class MainActivity extends Activity {
    ...
    static final OpenSku SKU_PREMIUM = new OpenSku(
            ...
            new Sku(AppstoreName.OPENSTORE, "openstore_sku_premium"));
    ...
    public void onCreate(Bundle savedInstanceState) {
         ...
         */
        String base64EncodedPublicKey = "ONSTRUCT_YOUR_KEY_AND_PLACE_IT_HERE";
    ...
    IabHelper.OnIabPurchaseFinishedListener mPurchaseFinishedListener = new IabHelper.OnIabPurchaseFinishedListener() {
        public void onIabPurchaseFinished(IabResult result, Purchase purchase) {
            ...
            if (SKU_GAS.sameAs(purchase.getSku())) {
                // bought 1/4 tank of gas. So consume it.
                Log.d(TAG, "Purchase is gas. Starting gas consumption.");
                mHelper.consumeAsync(purchase, mConsumeFinishedListener);
            }
            else if (SKU_PREMIUM.sameAs(purchase.getSku())) {
            ...
            else if (SKU_INFINITE_GAS.sameAs(purchase.getSku())) {
